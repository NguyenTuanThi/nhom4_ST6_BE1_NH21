                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        foreach ($getAllUser as $value) :
                            $getAllBillByStatus1 = $bill->getAllBillByStatus1($value['user_id']);
                            foreach ($getAllBillByStatus1 as $value1) :
                        ?>
                        <tr>
                            <td>
                                <?php echo $value1['id'] ?>
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-info btn-sm" href="updatestatus1.php?id=<?php echo $value1['id'] ?>">
                                    <i class="fas fa-pencil-alt"> </i>
                                    OK
                                </a>
                                <a class="btn btn-danger btn-sm" href="del.php?id=<?php echo $value1['id'] ?>">

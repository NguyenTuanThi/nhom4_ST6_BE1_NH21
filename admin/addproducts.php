...
<div class="content-wrapper">
  ...
  <section class="content">
    <form action="adding-process-product.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" id="inputProjectLeader" class="form-control" name="created_at">
                </div>
                <div class="form-group">
